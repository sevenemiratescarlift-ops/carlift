...
export const developerSettings = pgTable("developer_settings", {
  ...
  creditText: text("credit_text").default("Designed & Developed by").notNull(),
  developerName: varchar("developer_name", { length: 255 }).default("Afnan Afjal Rafi").notNull(),
...
export const inquiries = pgTable("inquiries", {
  ...
  selectedVehicleId: uuid("selected_vehicle_id").references(() => vehicles.id, { onDelete: "set null" }),
...
export const inquiriesRelations = relations(inquiries, ({ one }) => ({
  ...
  vehicle: one(vehicles, { fields: [inquiries.selectedVehicleId], references: [vehicles.id] }),
}));
