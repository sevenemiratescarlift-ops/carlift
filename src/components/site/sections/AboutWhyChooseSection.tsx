...
const HIGHLIGHTS = ["Reliable Transportation", "Professional Drivers", "Comfortable Vehicles", "24/7 Customer Support"];

export function AboutWhyChooseSection({ homepage }: { homepage: HomepageSettings }) {
  return (
    <section className="py-16 sm:py-20">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8">
        ...
        <Reveal direction="left" delay={0.1}>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[var(--color-accent)]">Why Choose Us</p>
